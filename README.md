# Core Handlers plugin distribution

This repository publishes the official **Stream Kit** distribution for the **Core Handlers** plugin (`core`).
...
1. Download `plugin-core.zip` from the [latest release](https://github.com/stream-kit-app/plugin-core/releases/latest).
